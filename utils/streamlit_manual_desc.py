...
def desc():
    ...
    st.write('''4. 파일에 변동사항이 생기면 i 모양의 아이콘과 함께 'Source file changed' 문구가 뜨며, 'Rerun'을 누르면 웹에 변동사항이 적용된다.
             'Always rerun'을 누르면 지속적으로 변동사항이 적용된다.''')
    st.image('./images/sl10.png', use_column_width = True)
    st.write('''#''')
